...
| Wireless | Hardware qualification | Both AU-configured radios pass channel/DFS checks, association, reconnect and 24-hour traffic soak |
...
6. Promote only the tested bundle. A different CPU mode or any new build requires a new qualification record.
